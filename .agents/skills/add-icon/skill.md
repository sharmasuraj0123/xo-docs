...
|----------|-----------|-------|
| AI model / LLM brand (Codex, GPT, Gemini, Mistral, etc.) | AI/LLM brand icon via @lobehub/icons | Download SVG → `public/icons/` |
...
Examples of available icons: `Codex`, `OpenAI`, `Gemini`, `Mistral`, `Llama`, `Grok`, `DeepSeek`, `Qwen`, `Cohere`, `Huggingface`, `Ollama`, `Perplexity`, `Groq`, `Together`, `Replicate`, etc.
