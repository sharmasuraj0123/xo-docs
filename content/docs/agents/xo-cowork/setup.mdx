...
Add more projects from the **Projects** sidebar, customize the agent's `AGENTS.md` / Soul / Identity / User files, or hop into the [XO Cowork API](/api-reference/overview) reference to drive the workspace programmatically.
