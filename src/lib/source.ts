...
const ICON_CLASSES: Record<string, string> = {
  ...
  Folder: "icon-[ph--folder-fill]",
  FolderOpen: "icon-[ph--folder-open-fill]",
  ...
  UserCog: "icon-[ph--user-gear-fill]",
  ...
  GitPullRequest: "icon-[ph--git-pull-request-fill]",
