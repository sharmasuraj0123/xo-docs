...
<Callout type="warn">
  After updating `openclaw.json`, open the [Configure panel](/getting-started/manage-workspace) and click **OpenClaw Restart** to restart the gateway. WhatsApp sessions are excluded from backups for security — reconnect them manually after a restore.
</Callout>
