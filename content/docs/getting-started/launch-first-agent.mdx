...
<Steps>
	<Step>
		...
		Open [beta.xo.builders](https://beta.xo.builders), click **New Project**, and select the agent template you chose. Give the XO project a unique name and complete the template's creation form.
	</Step>
	<Step>
