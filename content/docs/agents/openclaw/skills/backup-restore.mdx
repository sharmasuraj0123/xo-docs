...
- An [XO Workspace with OpenClaw deployed](/docs/agents/openclaw)
...
<Callout type="warn">
  After updating `openclaw.json`, open the **Launch** tab and click **[OpenClaw Restart](/docs/getting-started/manage-workspace#restarting-the-openclaw-gateway)** to restart the gateway. WhatsApp sessions are excluded from backups for security — reconnect them manually after a restore.
</Callout>
