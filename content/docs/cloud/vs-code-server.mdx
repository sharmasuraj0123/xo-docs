...
description: Open a browser-based VS Code IDE and start running commands in your space.
icon: Monitor
---
...
- A space machine in the **running** state (see [Manage Your Machine](/docs/getting-started/manage-space))
