...
<Steps>
  ...
  <Step>
    ...
    - **Access Token** — paste a token you create from your [Vercel account settings](https://vercel.com/account/tokens). Use this if you want scoped access or if your space blocks OAuth.
