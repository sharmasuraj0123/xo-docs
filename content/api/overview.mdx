...
`cowork-api` (the Space API) is a Python 3.12 FastAPI app that runs inside every Space on port `5002`. The frontend (Tauri desktop, browser, mobile, or any AI client) talks to it over plain HTTP plus Server-Sent Events.
