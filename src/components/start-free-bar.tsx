...
export function StartFreeBar() {
  ...
  return (
    <section
      className={cn(
        "fixed inset-x-0 bottom-0 z-40 border-t border-fd-border bg-fd-background/95 px-4 py-3 shadow-[0_-4px_24px_rgba(0,0,0,0.08)] backdrop-blur-md transition-transform duration-300 dark:shadow-[0_-4px_24px_rgba(0,0,0,0.35)]",
      ...
      <div className="mx-auto flex max-w-5xl flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex shrink-0 items-center gap-2">
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-lg border border-fd-border bg-fd-background px-3 py-2 text-sm font-semibold text-fd-foreground transition-colors hover:bg-fd-muted"
          ...
          <a
            ...
            className="inline-flex items-center rounded-lg bg-fd-primary px-4 py-2 text-sm font-semibold text-fd-primary-foreground transition-opacity hover:opacity-90"
            tabIndex={showBar ? 0 : -1}
          >
            Start Free
          </a>
