...
Go to [beta.xo.builders](https://beta.xo.builders), find the project showing the error, and click **Configure** in the top-right corner.
...
Once config is saved, restart OpenClaw to apply the changes. Either click the **OpenClaw Restart** button in **Configure**, or run this in the terminal:
