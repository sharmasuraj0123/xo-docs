...
<rect x="664.0" y="101.8" width="44" height="198.2" rx="3" fill="#8B5CF6"/>
<text x="630.0" y="95.9" textAnchor="middle" fontSize="12" fill="currentColor" style={{fontWeight:600}}>33.4</text>
<text x="686.0" y="94.8" textAnchor="middle" fontSize="12" fill="currentColor" style={{fontWeight:600}}>33.6</text>
