...
Run `openclaw models list | grep venice` in your terminal to confirm the provider is connected. You can also open `openclaw.json` in your space — the `agents.defaults` section reflects the new model:
