...
| --- | ---: | ---: |
| Scripted cross workspace operations | 1,920 | **0** (95 percent CI 0 to 0.0019) |
| Real agent cross workspace attempts | 35 | **0** |
...
<svg viewBox="0 0 760 250" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Cross workspace attempts succeed without the boundary and fail with it" style={{ width: '100%', height: 'auto', maxWidth: 760 }}>
<text x="56" y="26" fontSize="17" fill="currentColor" style={{fontWeight:600}}>The zero is a measurement, not a silence</text>
<text x="56" y="44" fontSize="12" fill="currentColor" fillOpacity="0.6">successful cross workspace operations out of 1,920 deliberate attempts</text>
