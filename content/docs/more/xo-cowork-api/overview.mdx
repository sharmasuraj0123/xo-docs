...
workspace is protected only when its upstream tunnel or workspace proxy validates
one of:
...
- [Quickstart](/more/xo-cowork-api/quickstart): verify the instance, discover its workspace, and stream a first chat turn.
